...
export class SubmittableExtrinsicMock {
...
// @ts-ignore currently unused local ignore
  public signAndSend (signer, callback) {
    let mock = new SubmittableResultMock(this.section, this.eventName, {isDropped: false, isFinalized: true, isInBlock: true, isInvalid:false, isUsurped: false});
    callback(mock);
  }
